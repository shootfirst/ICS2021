...
{"/bin/event-test", 43240, 433567, NULL, NULL},
{"/bin/time-test", 43240, 476807, NULL, NULL},
{"/bin/file-test", 48328, 520047, NULL, NULL},
{"/bin/dummy", 29068, 568375, NULL, NULL},
{"/bin/bmp-test", 48116, 597443, NULL, NULL},
  //******************************************pa3******************************************
#include "files.h"
};
